...
![LBOETest](https://github.com/Ferroxius/LBOE/assets/88400328/41bdabb5-3df0-46cf-9b30-7ebe21e0dac4)
...
- Obsidian Weathers and Skyrim is Luminous dealing with all matters weather and lighting
- Nordic Faces and other selected mods improving the general appearance of NPCs and the Player
- Postprocessing improvements from ENB, specifically Silent Horizons - Universal Core

**Gameplay**
- Blade and Blunt is used for combat, accompanied by mods such as Realistic AI Detection and Open World Loot
...
[ANVIL](https://github.com/Althro/Anvil) by Althro formed the baseline of the list. I thoroughly recommend it if you are looking to create your own Skyrim mod setup

Septimus by GuitarNinja was a major design influence and this modlist is made in its spirit

Various selections from lists such as Phoenix Flavour
...
- 150GB of storage space available in total approximately. Some extra headroom is recommended for Wabbajack
